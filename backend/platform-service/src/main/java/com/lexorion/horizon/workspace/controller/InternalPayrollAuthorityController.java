...
import com.lexorion.horizon.workspace.dto.InternalCapabilityResponse;
import com.lexorion.horizon.workspace.dto.InternalPayrollContextResponse;
...
public class InternalPayrollAuthorityController {
    ...
    private OrganizationWorkspace payrollWorkspace(String key) {
        OrganizationWorkspace workspace = workspaces.requireAccessibleWorkspace(key, "payroll");
        return workspace;
    }
