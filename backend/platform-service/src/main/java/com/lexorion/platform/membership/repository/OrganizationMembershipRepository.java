package com.lexorion.platform.membership.repository;
...
public interface OrganizationMembershipRepository extends JpaRepository<OrganizationMembership, UUID> {
   ...
   @Query("select membership\nfrom OrganizationMembership membership\nwhere membership.organization.id = :organizationId\n  and membership.role = com.lexorion.platform.membership.entity.OrganizationRole.OWNER\n  and membership.status = com.lexorion.platform.membership.entity.MembershipStatus.ACTIVE\n")
