...
@Component public class PlatformTenantAuthorityClient implements TenantAuthorityClient {
    ...
    public PlatformTenantAuthorityClient(RestClient.Builder builder,@Value("${lexorion.platform-service-url}") String baseUrl){client=builder.baseUrl(baseUrl).build();}
